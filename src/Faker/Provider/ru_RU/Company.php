...
class Company extends \Faker\Provider\Company
{
    ...
    public static function inn($area_code = "")
    {
        ...
        return $inn_base . self::innChecksum($inn_base);
    }
     ...
     */
    public static function innChecksum($inn)
    {
     ...
     * @return bool
     */
    public static function innIsValid($inn)
    {
        return strlen($inn) === 10 && self::innChecksum($inn) === $inn[9];
    }
}
